    ...
    'hover-elevate active-elevate-2',
  {
    variants: {
      variant: {
        ...
        destructive:
          'border-destructive-border bg-destructive text-destructive-foreground shadow-sm',
        outline:
          // @replit Shows the background color of whatever card / sidebar / accent background it is inside of.
          // Inherits the current text color. Uses shadow-xs. no shadow on active
          // No hover state
          'border shadow-xs [border-color:var(--button-outline)] active:shadow-none',
        secondary:
          // @replit border, no hover, no shadow, secondary border.
          'border border border-secondary-border bg-secondary text-secondary-foreground',

...
const tickerItems = [
  'AI-NATIVE ENGINEERING BEI 10+ TEAMS AUSGEROLLT',
  '500+ INGENIEURE AUF AI-NATIVE METHODIK GESCHULT',
  '20+ JAHRE ERFAHRUNG IM BAU VON SOFTWARE & PLATTFORMEN',
  'AI-PROGRAMM-LEITUNG FÜR DAS FÜHRENDE KLINISCHE INFORMATIONSSYSTEM DER SCHWEIZ',
  'AI-NATIVE CLM-PLATTFORM GEGRÜNDET, FINANZIERT & BIS ZUR AKQUISITIONSPHASE GEFÜHRT',
  'GELISTETER TECHNISCHER EXPERTE (ITDR) FÜR KOMPLEXE ICT- & AI-STREITFÄLLE',
  'OPENAI RED-TEAMING NETWORK ALUMNUS FÜR MODELLSICHERHEIT & MISSBRAUCHSRESILIENZ',
  'AI-TRANSFORMATION BEI 10+ MITTELSTÄNDISCHEN B2B-UNTERNEHMEN',
  'HEALTHCARE, LEGAL, FINANZ- & PUBLIC-SECTOR AI-SYSTEME',
] as const;
...
const pillars = [
  {
    ...
    short: 'Von Legacy-Prozessen zu autonomen Code-Fabriken',
    href: '/de/sdlc',
  },
  {
    tag: '02',
    label: 'AI SYSTEME',
    short: 'Vom Prozess-Mapping zu produktiven AI-Systemen',
    href: '/de/ai-transformation',
  },
  {
    tag: '03',
    label: 'GUTACHTEN & DD',
    short: 'Wenn Software zur Rechtsfrage wird',
    href: '/de/expert',
  },
] as const;

const focusTags = ['AI ENGINEERING', 'AI SYSTEME', 'GUTACHTEN & DD'] as const;
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-primary text-xs uppercase tracking-widest">
                Gordon Mickel / AI-Systeme &amp; Technische Expertise
              </span>
            </div>
            <h1
            ...
            <p className="max-w-lg text-lg text-muted-foreground leading-relaxed">
              Keine Slides. Keine Demos. Produktive AI-Systeme,
              SDLC-Transformationen und technische Gutachten für Unternehmen,
              bei denen es beim ersten Mal funktionieren muss.
            </p>
          </div>
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground text-xs leading-relaxed">
                {alertText ||
                  'Diagnose: Die meisten AI-Roadmaps sind gebaut, um zu beeindrucken, nicht um zu liefern. Ich teste Ihre gegen Daten, Architektur und Regulierung, bevor Sie ernsthaft Zeit und Kapital investieren.'}
              </p>
            </div>
          </aside>
        </div>

...
const offersEN: readonly Offer[] = [
  {
    ...
    duration: '2 weeks',
    outcome:
      'A defensible diagnosis. You leave with a quantified baseline and a sequenced plan that survives a board review.',
    deliverables: [
  ...
  },
  {
    ...
    duration: '6–8 weeks',
    outcome:
      '20–30% measurable cycle-time reduction in the first 90 days. A team that owns the methodology, not a vendor that owns it for them.',
    deliverables: [
  ...
  },
  {
    ...
    duration: '3–6 months',
    outcome:
      '2–3x sustained throughput. Most production code reviewed (or written) by agents. Engineering organisation reshaped around product/spec leadership.',
    deliverables: [

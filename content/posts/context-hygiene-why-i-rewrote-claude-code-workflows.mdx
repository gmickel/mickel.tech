...
I just released [Flow](/apps/flow). It's a Claude Code plugin that streamlines the development lifecycle. It stands on the shoulders of giants, fully integrating with both [RepoPrompt](https://repoprompt.com) and optionally [Steve Yegge's Beads](https://github.com/steveyegge/beads).

![Flow: Streamlined Development Lifecycle](/flow/flow.jpg)
